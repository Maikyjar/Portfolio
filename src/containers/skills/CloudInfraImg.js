...
export default function CloudInfraImg(props) {
  ...
  return (
    ...
    >
      ...
      <path
        fill="#fa2080"
        d="M22.203 1.792H4.28c-1.39 0-2.28 1.47-1.63 2.692l1.794 3.377h-3.25a1.2 1.2 0 0 0-.588.154a1.192 1.192 0 0 0-.435.421a1.185 1.185 0 0 0-.034 1.168l5.766 10.859c.101.19.253.35.44.462a1.2 1.2 0 0 0 1.232 0a1.191 1.191 0 0 0 .44-.463l1.566-2.933l1.965 3.701c.691 1.302 2.564 1.304 3.258.004l8.983-16.818c.635-1.19-.232-2.623-1.585-2.623Zm-8.05 7.186l-3.874 7.253a.793.793 0 0 1-.293.308a.799.799 0 0 1-.82 0a.793.793 0 0 1-.292-.308L5.038 9.01a.788.788 0 0 1 .02-.778a.793.793 0 0 1 .29-.281a.798.798 0 0 1 .39-.103h7.731a.777.777 0 0 1 .381.1a.772.772 0 0 1 .282.273a.767.767 0 0 1 .02.758z"
        transform="translate(260 500) scale(4)"
      />
      <g opacity="0.7">
        <rect
          x="682.04"
